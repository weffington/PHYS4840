program RungeKutta4_1
    ...
    open(unit=10, file="rk4_results1.dat", status="replace")
    write(10,*) "t x"
    write(10,*) t, x
    ...
    print *, "Integration complete. Results saved to rk4_results1.dat"
    
end program RungeKutta4_1