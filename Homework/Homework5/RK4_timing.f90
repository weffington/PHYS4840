program RungeKuttaTiming
    ...
    open(unit=10, file="rk4_timing.dat", status="replace")
    write(10,*) "t x"
    write(10,*) t, x
    ...
    print *, "Integration complete. Results saved to rk4_timing.dat"
    
end program RungeKuttaTiming